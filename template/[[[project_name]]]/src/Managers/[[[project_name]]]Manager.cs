...
namespace [[[project_name]]].Managers {
    public class [[[project_name]]]Manager {
        ...
        public void CheckFor[[[project_name]]]() {
        ...
        public static implicit operator bool([[[project_name]]]Manager? instance) {
            return instance != null;
        }

        #region Singleton

        private static [[[project_name]]]Manager? _instance;

        public static [[[project_name]]]Manager Instance {
            get { return _instance ??= new [[[project_name]]]Manager(); }
        }

        public static void Instantiate() {
            _instance = new [[[project_name]]]Manager();
        }
